...
export default function AccountTxn({
  ...
  const timeSince = useTimePassed(DateTime.fromISO(blockTimestamp).toMillis());
  return (
    <div
      className={`flex ${direction === "To" ? "bg-brand-red" : "bg-brand-green"} px-5 py-4 md:px-4 md:py-2.5 gap-x-2 border-2 border-black rounded-2xl md:rounded-3xl overflow-hidden`}
    >
      <span className="my-1">
